...
### AI 요약 적용 범위 보강 (2026-07-23)

이상 진단 카드(`AnomalyDetailView`)에도 AI 요약 버튼 — 해당 시설 스코프의
scan-all explain([E-022] 시설 필터) 재사용. 설비별 "AI 원인 분석"은 화면
수치 재서술로 정보 가치가 없어 제거됨 (2026-07-22).
