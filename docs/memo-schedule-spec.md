...
메모 달력도 동일 (2026-07-23): 날짜 셀 더블클릭 → **새 메모 작성** 창.
메모는 작성일 자동 기록이라 날짜 프리필 없음 (항목 클릭=보기/수정 유지).

---

## 부기 (2026-07-28) — 메모 기본 보기 = 달력

업무 메모 화면의 기본 보기를 목록 → **달력**으로 변경, 토글 순서도
[달력][목록] (사용자 결정 — 메모는 날짜 맥락으로 먼저 읽힌다).
