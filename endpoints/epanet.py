...
def _check_data_quality(region: str) -> dict:
    ...
    # 6) HAS_TIME_PATTERN — 별도 테이블 미구현 (Phase 3)
    checks["HAS_TIME_PATTERN"] = {
        "ok": False,
        "detail": "tb_epanet_time_pattern 미구현 (Phase 3)",
    }
    # 7) HAS_METER_MAPPING — 별도 테이블 미구현 (Phase 3)
    checks["HAS_METER_MAPPING"] = {
        "ok": False,
        "detail": "tb_epanet_meter_map 미구현 (Phase 3)",
    }
