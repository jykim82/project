...
- `docs/canvas-editor-unification-spec.md` — 캔버스 에디터 일원화 v1 (좌표 정본 tb_flow_diagram_node 통일 — tb_canvas_node_position 폐기(0120 rename). px↔경위도 백엔드 변환, PUT full-diff→명시 diff+causal 리로드, relayout·lint 툴바 이식, P2 노드 배치 탭 제거·/setup/canvas redirect)
