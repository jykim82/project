...
- `docs/realtime-comm-spec.md` — 사용자 간 채팅·영상·음성 v1 (확정: 영상=파일 공유 우선·음성=운영자 통화·1:1·순차. P1 메신저(0106·/messenger·3s 폴링) + P2 파일 전송(0107·사진/영상/음성메시지·Range 서빙·도착 토스트) 구현 완료. wss/WebRTC 는 P3)
