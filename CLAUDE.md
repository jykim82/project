...
- `docs/chat-history-server-spec.md` — 채팅 대화 목록 서버 계정 전환 v1 (localStorage→tb_ai_chat_group/tb_ai_chat_message jsonb, Migration 0119. 서버-우선+로컬 폴백, 일회성 이관 멱등 import. ai 메모리 세션·/ask/stream 계약 불변)
