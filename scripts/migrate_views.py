...
conn = psycopg2.connect(
    host="112.166.183.65", port=25479, dbname="postgres",
    user="postgres", password="DJpost0827///"
)
conn.autocommit = True
cur = conn.cursor()

# 1. v_reservoir_info_status
cur.execute("""
...
# 2. v_booster_station_info_status
cur.execute("""
...
# 3. v_pressure_reducing_facility_info_status
cur.execute("""
...
# Verify
cur.execute("SELECT column_name FROM information_schema.columns WHERE table_name='v_reservoir_info_status' AND column_name LIKE '%url' ORDER BY 1")
